...
✔First type the sc ,repo or script command and you will get Matelee md repository 
✔From there you are required to get your *Session id* but how,??..
         𝐇𝐎𝐖 𝐓𝐎 𝐆𝐄𝐓 𝐒𝐄𝐒𝐒𝐈𝐎𝐍 𝐈𝐃
✞ Open this link 👉 https://timnasa1-1.onrender.com   then tap on pair code.
✞ Enter your whatsapp number with the country code e.g;  255693629079 then tap submit 
...
✞ After a successful login Matelee-md owner 🤔 Matelee will send you a *session id* .some will wonder where the hell is that session ,,,...It is just right at your inbox /dm {your own number for whatsappp} 😂
✞Copy the Session id {the one with unreadable codes and long copy it and send it to your deployer or deploy
     𝐇𝐎𝐖 𝐓𝐎 𝐃𝐄𝐏𝐋𝐎𝐘 *MATELEE-MD*
✔ Now check on Rahmani-md repository in github fork and give a star to this repository before doing anything 🌟or else Rahmani-md owner won't allow you to deploy his bot🤖.
...
✔Now click on this devs number and give Matelee-md owner credits https://wa.me/255697993596
╰────────────────────☆`;
let menuMsg = `
     𝐑𝐞𝐠𝐚𝐫𝐝𝐬 dev Rahmani`;
   var lien = mybotpic();
