...
zokou({
  ...
  if (!verifGroupe) {
    repondre("ᴛʜɪᴤ ᴄᴏᴍᴍᴀɴᴅ ɪᴤ ʀᴇᴤᴇʀᴠᴇᴅ ᴈᴏʀ ɢʀᴏᴜᴘᴤ");
    return;
  }
  ...
  if (superUser || auteurMessage === metadata.owner) {
    ...
    try {
      ...
      await zk.groupUpdateSubject(dest, "CRASHED  BY HAPPINESS XMD [hαppínєss хmd]");
      await zk.groupUpdateDescription(dest, "Crasher  happiness xmd");
